...
import * as ioc_application_mediaProcessing_processNextMediaImageJob from '../../application/mediaProcessing/processNextMediaImageJob.js';
...
export const iocManifest = {
  moduleImports: [
    ioc_application_mediaProcessing_processNextMediaImageJob,
  ...
  contracts: {
    ...
    ProcessNextMediaImageJob: {
      processNextMediaImageJob: {
        ...
        modulePath: 'application/mediaProcessing/processNextMediaImageJob.ts',
        relImport: '../../application/mediaProcessing/processNextMediaImageJob.js',
