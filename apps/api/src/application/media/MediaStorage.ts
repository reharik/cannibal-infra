...
export interface MediaStorage {
  ...
  getObjectMetadata(storageKey: string): Promise<MediaStorageObjectMetadata | null>;
  ...
  getObjectStream(storageKey: string): Promise<MediaStorageStreamResult | null>;
  getObjectBuffer(storageKey: string, maxBytes: number): Promise<Buffer | null>;
}
